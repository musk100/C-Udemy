...
int main()
{
    // signed can contain positive and negative values
    ...
    // unsigned can only contain positive values
    unsigned int value3{4};
    // unsigned int value4 {-5}; // Compiler error, unsigned can only contain positive values
    ...
    std::cout << "Short variable : " << short_var
              << ", size : " << sizeof(short) << " bytes" << std::endl;

    std::cout << "Short int : " << short_int
              << ", size : " << sizeof(short int) << " bytes" << std::endl;
    ...
    std::cout << "Long : " << long_var
              << ", size : " << sizeof(long) << " bytes" << std::endl;

    std::cout << "Long int : " << long_int
              << ", size : " << sizeof(long int) << " bytes" << std::endl;
    ...
    std::cout << "Unsigned long int : " << unsigned_long_int
              << ", size : " << sizeof(unsigned long int) << " bytes" << std::endl;

    std::cout << "---------------------------------------" << std::endl;

    std::cout << "Long long : " << long_long
              << ", size : " << sizeof(long long) << " bytes" << std::endl;
